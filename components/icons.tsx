...
export const BrainCircuitIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-gray-400">
        ...
        <path d="M12 5a3 3 0 1 0 5.993.251"/>
        <path d="M12 5a3 3 0 1 1 .01 0"/>
        <path d="M12 19a3 3 0 1 0-5.993-.251"/>
        <path d="M12 19a3 3 0 1 0 5.993.251"/>
        <path d="M12 19a3 3 0 1 1 .01 0"/>
        <path d="M5 12a3 3 0 1 0-.251 5.993"/>
        <path d="M5 12a3 3 0 1 0 .251 5.993"/>
        <path d="M5 12a3 3 0 1 1 0-.01"/>
        <path d="M19 12a3 3 0 1 0-.251 5.993"/>
        <path d="M19 12a3 3 0 1 0 .251 5.993"/>
        <path d="M19 12a3 3 0 1 1 0-.01"/>
        <path d="M12 5a3 3 0 1 0-5.993.251"/>
        <path d="M12 5a3 3 0 1 0 5.993.251"/>
        <path d="M12 5a3 3 0 1 1 .01 0"/>
        <path d="M12 12h.01"/>
